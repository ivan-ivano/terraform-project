...
output "lambda_save_course_arn" {
    value = module.lambda_save_course.lambda_function_arn
}
...
output "lambda_update_course_arn" {
    value = module.lambda_update_course.lambda_function_arn
}
